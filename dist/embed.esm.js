/* haircited-embed v1.0.0 | MIT | https://widget.haircited.com */
...
function makeWidgetElement(widgetType, initFn, domainAttrs) {
  ...
  return class extends HTMLElement {
    ...
    connectedCallback() {
      ...
      this._syncDataAttrs();
      initFn(this, '{"site":"haircited","name":"HairCited","domain":"haircited.com","accent":"#8B5CF6","attribute":"data-haircited","apiBase":"https://haircited.com/api/","searchPath":"/search/","organName":"Hair Health","organSlug":"hair"}');
    }
     ...
     */
    _syncDataAttrs() {
      const attrKey = '{"site":"haircited","name":"HairCited","domain":"haircited.com","accent":"#8B5CF6","attribute":"data-haircited","apiBase":"https://haircited.com/api/","searchPath":"/search/","organName":"Hair Health","organSlug":"hair"}'.attribute.replace("data-", "");
...
(function bootstrap() {
  const config = '{"site":"haircited","name":"HairCited","domain":"haircited.com","accent":"#8B5CF6","attribute":"data-haircited","apiBase":"https://haircited.com/api/","searchPath":"/search/","organName":"Hair Health","organSlug":"hair"}';
